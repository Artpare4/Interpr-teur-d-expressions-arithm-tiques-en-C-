...
-main.cpp : fichier contanant programme principale
...
Utilisation des pile/file chaînée:
...
Définition de la fonction de l'évaluation d'une expression dans le fichier main.cpp:
...
Une file d'expression utilise un Noeud contenant une expression. Et si la classe Expression avait besoin de la classe FileExpression pour la méthode "evaluer", cela créé une dépendance circulaire.
